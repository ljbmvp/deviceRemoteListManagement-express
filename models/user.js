...
User.getUserNumByName = function getUserNumByName(username, callback) {
 ...
 //删除用户记录
User.delUserByUserName = function getUserNumByName(username, callback) {
    pool.getConnection(function (err, connection) {
           var useDbSql = "USE " + DB_NAME;
    connection.query(useDbSql, function (err) {
         if (err) {
        ...
        var getUserByUserName_Sql = "DELETE FROM userinfo WHERE username = ?";
...
User.getUserList= function getUserNumByName( callback) {
    pool.getConnection(function (err, connection) {
           var useDbSql = "USE " + DB_NAME;
    connection.query(useDbSql, function (err) {
         if (err) {
        ...
        var getUserByUserName_Sql = "SELECT * FROM userinfo";
